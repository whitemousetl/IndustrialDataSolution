...
- 异常层次结构
  ...
  - 通信层共享异常 CommunicationException、DeviceUnavailableException、TransientCommunicationException。
...
- [RequestLoggingMiddleware.cs](file://IndustrialDataSolution/IndustrialDataProcessor.Api/Middleware/RequestLoggingMiddleware.cs#L36-L79)
...
- 通信层共享异常 CommunicationException、DeviceUnavailableException、TransientCommunicationException：用于通信层的可恢复/不可恢复异常场景。
...
IndustrialDataException <|-- CommunicationException
