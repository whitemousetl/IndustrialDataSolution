...
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs)
...
- [WriteTask.cs](file://IndustrialDataProcessor.Domain/Workstation/WriteTask.cs)
...
**图表来源**
- [IProtocolDriver.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IProtocolDriver.cs#L7-L13)
...
- [ModbusTcpNetDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/ModbusTcpNetDriver.cs#L11-L41)
- [ModbusRtuOverTcpDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/ModbusRtuOverTcpDriver.cs#L11-L41)
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L9-L97)
- [DependencyInjection.cs](file://IndustrialDataProcessor.Infrastructure/DependencyInjection.cs#L55-L62)
...
**章节来源**
- [IProtocolDriver.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IProtocolDriver.cs#L7-L13)
- [PointResult.cs](file://IndustrialDataProcessor.Domain/Workstation/Results/PointResult.cs#L5-L15)
- [ProtocolResult.cs](file://IndustrialDataProcessor.Domain/Workstation/Results/ProtocolResult.cs#L5-L26)
...
**图表来源**
- [IProtocolDriver.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IProtocolDriver.cs#L7-L13)
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L12-L98)
- [ModbusTcpNetDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/ModbusTcpNetDriver.cs#L11-L41)
- [ModbusRtuOverTcpDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/ModbusRtuOverTcpDriver.cs#L11-L41)
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L9-L97)
...
**章节来源**
- [IProtocolDriver.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IProtocolDriver.cs#L7-L13)
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L16-L22)
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L77-L81)
...
- 具体驱动实现
  - ModbusTcpNetDriver 与 ModbusRtuOverTcpDriver 通过 HslReadWriteExtensions 将底层 IReadWriteNet 的读写封装为 PointResult/写入结果
...
**图表来源**
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L26-L41)
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L11-L43)
- [IConnectionHandle.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IConnectionHandle.cs#L10-L17)
...
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L11-L97)
...
**图表来源**
- [ProtocolResult.cs](file://IndustrialDataProcessor.Domain/Workstation/Results/ProtocolResult.cs#L5-L26)
- [IProtocolDriver.cs](file://IndustrialDataProcessor.Domain/Communication/IConnection/IProtocolDriver.cs#L9-L11)
...
**章节来源**
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L43-L72)
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L45-L90)
...
## 依赖关系分析
- 接口到实现
  - IProtocolDriver 由多个具体驱动实现（如 ModbusTcpNetDriver、ModbusRtuOverTcpDriver）
...
- [ProtocolConfig.cs](file://IndustrialDataProcessor.Domain/Workstation/Configs/ProtocolConfig.cs#L8-L64)
- [ParameterConfig.cs](file://IndustrialDataProcessor.Domain/Workstation/Configs/ParameterConfig.cs#L7-L84)
- [WriteTask.cs](file://IndustrialDataProcessor.Domain/Workstation/WriteTask.cs#L5-L11)
...
**章节来源**
- [BaseProtocolDriver.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Drivers/TcpCommon/BaseProtocolDriver.cs#L36-L71)
- [HslReadWriteExtensions.cs](file://IndustrialDataProcessor.Infrastructure/Communication/Extensions/HslReadWriteExtensions.cs#L73-L84)
